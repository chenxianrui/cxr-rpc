package com.example.cxrrpc.utils.concurrent.threadpool;
...
public final class ThreadPoolFactoryUtils {
    ...
    public static void printThreadPoolStatus(ThreadPoolExecutor threadPool) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(() -> {
            log.info("============线程池状态=============");
            log.info("线程数量: [{}]", threadPool.getPoolSize());
            log.info("正在运行的线程: [{}]", threadPool.getActiveCount());
            log.info("任务数量 : [{}]", threadPool.getCompletedTaskCount());
            log.info("在队列中的任务数量: {}", threadPool.getQueue().size());
            log.info("===========================================");
