package com.example.registry.zk.util;

import com.example.enums.RpcConfigEnum;
import com.example.exception.RpcException;
import com.example.utils.file.PropertiesFileUtils;
...
public final class CuratorUtils {
    ...
    public static final String ZK_REGISTER_ROOT_PATH = "/cxr-rpc";    // zookeeper下路径
